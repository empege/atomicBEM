...
templates['modalShowcase'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div style=\"opacity:1;display:block;position:relative;\" class=\"m-modal "
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"modifiers") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":71},"end":{"line":2,"column":117}}})) != null ? stack1 : "")
